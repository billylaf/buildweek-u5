...
var _excluded = ["keyname", "name", "rename", "panel", "label"];
var Username = exports.Username = /*#__PURE__*/(0, _react.memo)(function (props) {
  ...
  (0, _react.useEffect)(function () {
    return dispatch((0, _defineProperty2["default"])({}, "$$".concat(panelName).concat(key), label));
  }, [label]);
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactLoginPage.Input, (0, _objectSpread2["default"])((0, _objectSpread2["default"])({
    ...
    name: nameBase,
    keyname: "$$".concat(panelName).concat(key)
  }));
});
