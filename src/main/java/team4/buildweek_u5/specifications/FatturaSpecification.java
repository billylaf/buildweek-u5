...
public class FatturaSpecification {
    ...
    public static Specification<Fattura> hasAnno(Integer anno) {
        return (root, query, cb) ->
                anno == null
                        ? null
                        // cb.function chiama la funzione SQL "YEAR" sulla colonna dataFattura
                        : cb.equal(cb.function("YEAR", Integer.class, root.get("dataFattura")), anno); // SQL: WHERE YEAR(data_fattura) = anno
    }
